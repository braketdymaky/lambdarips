...
UrgenciasColumnas = namedtuple('UrgenciasArchivo',
                               ['n_factura_posicion',
                                ...
                                'tipo_id_posicion',
                                'id_posicion',
                                'fecha_ingreso_posicion',
                                'hora_ingreso_posicion',
                                'n_autorizacion_posicion',
                                'causa_externa_posicion',
                                'co_diagnostico_princ_posicion',
                                'co_diagnostico1_posicion',
                                'co_diagnostico2_posicion',
                                'co_diagnostico3_posicion',
                                'destino_usuario_posicion',
                                'estado_salida_posicion',
                                'causa_muerte_posicion',
                                'fecha_salida_poscion',
...
class UrgenciasColumnasEnum(Enum):
    ...
    # metodo para obtener la posicion y longitud  de la causa de muerte de urgencias
    @property
    def obtener_causa_muerte(self):
        response = self.value.causa_muerte_posicion
        return response
