class ModeloFichero:
    ...
    def asignar_tipo_archivo(self, tipo_archivo):
        self.__tipo_archivo = tipo_archivo

    def obtener_tipo_archivo(self):
        return self.__tipo_archivo

    def asignar_errores(self, errores):
    ...
    def asignar_cups_vacunas(self, cups_vacunas):
        self.__cups_vacunas = cups_vacunas

    def obtener_cups_vacunas(self):
        return self.__cups_vacunas
    ...
    def asignar_departmamento(self, departmamento):
        self.__departamento = departmamento

    def obtener_departmamento(self):
