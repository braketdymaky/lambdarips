...
class UrgenciasColumnasEnum(Enum):
    AU = UrgenciasColumnas(0, 20, 1, 10, 2, 2, 3, 20, 4, 10, 5, 5, 6, 15, 7, 2, 8, 4, 9, 4, 10, 4, 11, 4, 12, 1, 13, 1,
                           14, 4, 15, 10, 16, 5)

    # Metodo para obtener la lista con las posiciones y longitudes
    @property
    def obtener_lista(self):
        lista_transacciones = [[0, 20], [1, 12], [2, 2], [3, 20], [4, 10], [5, 5], [6, 15], [7, 2], [8, 4], [9, 4], [10, 4], [11, 4], [12, 1], [13, 1],[14, 4], [15, 10], [16, 5]]
