...
class ProcedimientosColumnasEnum(Enum):
    AP = ProcedimientosColumnas(0, 20, 1, 10, 2, 2, 3, 20, 4, 10, 5, 15, 6, 8, 7, 1, 8, 1, 9, 1, 10, 4, 11, 4, 12, 4,
                                13, 1, 14, 15)

    # Metodo para obtener la lista con las posiciones y longitudes
    @property
    def obtener_lista(self):
        lista_archivo =[[0, 20], [1, 12], [2, 2], [3, 20], [4, 10], [5, 15], [6, 8], [7, 1], [8, 1], [9, 1], [10, 4], [11, 4], [12, 4],[13, 1], [14, 15]]
