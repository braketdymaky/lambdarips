...
class MedicamentosColumnasEnum(Enum):
    AM = MedicamentosColumnas(0, 20, 1, 12, 2, 2, 3, 16, 4, 20, 5, 20, 6, 1, 7, 30, 8, 20, 9, 20, 10, 20, 11, 5, 12, 15,
                              13, 15)

    # Metodo para obtener la lista con las posiciones y longitudes
    @property
    def obtener_lista(self):
        lista_archivo = [[0, 20], [1, 12], [2, 2], [3, 16], [4, 20], [5, 20], [6, 1], [7, 30], [8, 20], [9, 20], [10, 20], [11, 5], [12, 15],[13, 15]]
