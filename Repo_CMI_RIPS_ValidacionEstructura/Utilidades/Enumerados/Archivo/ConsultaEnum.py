...
class ArchivosConsultaColumnasEnum(Enum):
    AC = ArchivosConsultaColumnas(0, 20, 1, 12, 2, 2, 3, 20, 4, 10, 5, 15, 6, 8, 7, 2, 8, 2, 9, 4, 10, 4, 11, 4, 12, 4,
                                  13, 1, 14, 15, 15, 15, 16, 15)

    # Metodo para obtener la lista con las posiciones y longitudes
    @property
    def obtener_lista(self):
        lista_archivo_consulta = [[0, 20], [1, 12], [2, 2], [3, 16], [4, 10], [5, 15], [6, 8], [7, 2], [8, 2], [9, 4],
