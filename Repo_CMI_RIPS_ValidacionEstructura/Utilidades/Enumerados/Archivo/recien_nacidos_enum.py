12# enum necesarios para las constantes pertenecientes al archivo de recien nacidos
...
class RecienNacidosColumnaEnum(Enum):
    AN = RecienNacidosColumnas(0, 20, 1, 12, 2, 2, 3, 16, 4, 10, 5, 5, 6, 2, 7, 1, 8, 1, 9, 4, 10, 4, 11, 4, 12, 10, 13,
                               5)
    # Metodo para obtener la lista con las posiciones y longitudes
    @property
    def obtener_lista(self):
        lista_archivo =[[0, 20], [1, 12], [2, 2], [3, 16], [4, 10], [5, 5], [6, 2], [7, 1], [8, 1], [9, 4], [10, 4], [11, 4], [12, 10], [13,5]]
