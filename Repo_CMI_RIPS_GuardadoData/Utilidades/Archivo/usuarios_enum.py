...
UsuariosColumnas = namedtuple('Usuarios', ['tipo_id_posicion', 'id_posicion', 'codigo_prestador_posicion',
                                           'tipo_usuario_posicion', 'p_apellido_posicion', 's_apellido_posicon',
                                           'p_nombre_posicion', 's_nombre_posicion', 'edad_poscion',
                                           'u_medida_edad_posicion', 'sexo_posicion', 'c_dpto_residencia_posicion',
                                           'c_municipio_residencia_posicion', 'zona_residencial_posicion'])
